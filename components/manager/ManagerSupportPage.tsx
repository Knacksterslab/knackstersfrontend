...
import { managerSupportApi } from '@/lib/api/client'
import {
  Send,
  AlertCircle,
  CheckCircle,
...
export default function ManagerSupportPage() {
  ...
  useEffect(() => {
    managerSupportApi.getTickets().then((res: any) => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const response = await managerSupportApi.createTicket({
      ...
      if (response.success && response.data) {
        setTicketNumber((response.data as any).ticketNumber)
        setShowSuccess(true)
        ...
        setError((response as any).error || 'Failed to submit ticket')
      }
    } catch (err: any) {
            ...
            <div className="space-y-5">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-400 focus:border-transparent disabled:bg-gray-50"
                />
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <select
                    ...
                    onChange={handleChange}
                    disabled={isSubmitting}
                    className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-400 bg-white disabled:bg-gray-50"
                  >
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={6}
                  disabled={isSubmitting}
                  className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-400 resize-none disabled:bg-gray-50"
                />
              </div>
