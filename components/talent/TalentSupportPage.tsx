...
export default function TalentSupportPage() {
  ...
  const quickLinks = [
    { icon: BookOpen, title: 'FAQ', description: 'Find answers to common questions', color: 'blue' },
    { icon: FileText, title: 'Documentation', description: 'Detailed guides and tutorials', color: 'green' },
    { icon: Video, title: 'Video Tutorials', description: 'Learn through video content', color: 'purple' },
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <div className="space-y-6">
                ...
                <div className="bg-white rounded-xl border border-gray-200 p-6">
                    ...
                    <div>
                      ...
                      <div className="space-y-2">
                        <div className="flex items-center gap-2 text-sm text-gray-700">
                          ...
                          <span>sarah.johnson@knacksters.com</span>
                        </div>
                        <div className="flex items-center gap-2 text-sm text-gray-700">
                  ...
                  <button className="w-full py-3 border-2 border-orange-500 text-orange-500 rounded-lg font-semibold hover:bg-orange-50 transition-colors">
                    Contact Manager
                  </button>
                </div>
