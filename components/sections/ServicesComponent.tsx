    ...
    <section id="services" className="w-full py-8 px-4 sm:py-12 md:py-16 lg:py-20 bg-[#262626]">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mb-8 sm:mb-10 md:mb-12">
          <h2 className="text-[2.5rem] font-normal text-white mb-3 sm:mb-4">
            {title}
          </h2>
          <p
            className="max-w-3xl"
        ...
        <div className="overflow-hidden">
          <div className="grid grid-cols-1 sm:grid-cols-1 lg:grid-cols-2">
            {items.map((service, index) => {
              ...
              <div className="sm:flex items-stretch gap-4 sm:gap-5 md:gap-5">
                {/* Icon Container */}
                <div className="flex justify-center sm:block shrink-0 self-stretch">
                  <div
                    className="rounded-xl flex items-center justify-center p-3 sm:p-4 h-full"
                    style={{
                      width: "190px",
                      height: "214.65px",
                      backgroundImage:
                ...
                {/* Content */}
                <div className="flex flex-col items-center sm:items-start sm:block flex-1 min-w-0 mt-[10px] sm:mt-0">
                  <h3
                    className="text-lg sm:text-xl md:text-xl font-semibold text-white mb-2 sm:mb-3 font-sans"
                    style={{
                  ...
                  <p
                    className="text-center sm:text-left text-[14px] text-[#BFBFBF] font-sans leading-relaxed mb-4"
                    style={{
                      fontFamily: "var(--font-sans), Lato, sans-serif",
                    }}
                  >
            ...
            {/* CTA Card */}
            <div className="lg:p-4 lg:pr-0 lg:pb-0 lg:pt-6">
              <div className="p-5 flex flex-col items-center justify-center gap-2 sm:gap-3 rounded-xl h-full" style={{
                background:
                ...
                >
                  <span className="text-white text-sm sm:text-3xl font-medium mb-6" style={{ fontFamily: 'var(--font-sans), Lato, sans-serif' }}>{ctaCard.title}</span>
                  <svg
