          ...
          <div className="space-y-4 sm:space-y-5">
            ...
            <div className="relative my-1">
              ...
              <div className="relative flex justify-center text-xs">
                <span className="px-3 bg-gray-50 text-gray-400">or sign up faster with</span>
              </div>
            </div>
            ...
            <button
              ...
              disabled={isLoading}
              className="w-full px-6 py-3 bg-white border-2 border-gray-200 text-gray-700 rounded-lg hover:bg-gray-50 hover:border-gray-300 transition-all font-semibold text-base disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-3"
            >
